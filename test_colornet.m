...
title('Input Layer', 'FontSize', 14); 
%annotation('textbox', [0.8 0.8 0.1 0.1], 'String', ['\sigma = ' sprintf('%g', width_factor)])
...
axis tight
title('Output Layer', 'FontSize', 14); 
xlabel '\lambda (nm)'
ylabel 'Output'
hline(0.5, 'k:')
annotation('textbox', [0.7 0.3 0.1 0.1], 'String', sprintf('Hidden neurons: %g', num_hidden_units))
